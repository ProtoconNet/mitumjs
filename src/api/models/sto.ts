...
async function getPartitions(
  ...
  const apiPath = `${url(api, contract)}/holder/${Address.from(
    holder
  ).toString()}/partitions`;
  const encodedString = encodeURIComponent(apiPath);
  return !delegate
...
async function getBalanceByHolder(
  ...
  const apiPath = `${url(api, contract)}/holder/${Address.from(
    holder
  ).toString()}/partition/${partition}/balance`;
  const encodedString = encodeURIComponent(apiPath);
  return !delegate
    ? await axios.get(apiPath)
    : await axios.get(delegateAddress + encodedString);
...
async function getOperatorsByHolder(
  ...
  return await axios.get(
    `${url(api, contract)}/holder/${Address.from(
      holder
    ).toString()}/partition/${partition}/operators`
  );
}
...
async function getPartitionBalance(
  ...
  return await axios.get(
    `${url(api, contract)}/partition/${partition}/balance`
  );
}
...
async function getAuthorized(
  ...
  return await axios.get(
    `${url(api, contract)}/operator/${Address.from(
      operator
    ).toString()}/holders`
  );
}
